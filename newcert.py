...
KEY_FILE = "server.key"
CLIENT_SECRET_KEY_FILE = "secret.key"
...
def generate_client_secret_key():
    """Generate a Fernet symmetric key and save it to a file."""
    secret_key = Fernet.generate_key()  # Tạo khóa đối xứng Fernet (32 bytes)

    with open(CLIENT_SECRET_KEY_FILE, "wb") as f:
        f.write(secret_key)  # Lưu khóa vào file

    print(f"[✔] Client secret key generated and saved to {CLIENT_SECRET_KEY_FILE}")
