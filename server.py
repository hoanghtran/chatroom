        ...
        if authenticate(username, password):
            ...
            if totp.verify(otp_input):
                ...
                if attempts >0:
                    ...
                    ssl_client.send("Đăng nhập thất bại! Hết số lần thử, thử lại sau 30 giây.\n".encode())
                    time.sleep(10)
                    continue
        else:
            attempts -= 1
...
def handle_register(ssl_client):
    while True:
        ...
        # Thông báo đăng ký thành công, kèm OTP secret để user cấu hình app (có thể thay bằng QR code trong triển khai thực tế)
